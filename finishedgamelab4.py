...
def remove_punct(text):
    ...
    """
    no_punct = ""							
    for ch in text:									#for each charater in the imported text
...
def remove_spaces(text):
    ...
    ''
    """
    no_space = text.strip()					#removes spaces from imported text
    return no_space
...
def normalise_input(user_input):
    ...
    'help'
    """
    user_input = remove_punct(user_input)		#calls the remove punction function inputting user_input as an argument
    user_input = remove_spaces(user_input)		#calls the remove spaces function inputting user_input as an argument
    return user_input.lower()					#returns output and makes it lowercase
